Shader "AllIn1SpriteShader/AllIn1SpriteShaderUiMask"
{
	Properties
	{
		...
		_ShineMask("Shine Mask", 2D) = "white" {} // 135

		_GlitchSize("Glitch Size", Range(0.25, 5)) = 1 //136
		_HologramStripeColor("Stripes Color", Color) = (0,1,1,1) //137
		_GradBoostX("Boost X axis", Range(0.1, 5)) = 1.2 //138
		_GradBoostY("Boost Y axis", Range(0.1, 5)) = 1.2 //139
		[Toggle()] _GradIsRadial("Radial Gradient?", float) = 0 //140
		_AlphaRoundThreshold("Round Threshold", Range(0.005, 1.0)) = 0.5 //141
		_GrassRadialBend("Radial Bend", Range(0.0, 5.0)) = 0.1 //142

		[HideInInspector] _MinXUV("_MinXUV", Range(0, 1)) = 0.0 //143
		...
		[HideInInspector] _RandomSeed("_MaxYUV", Range(0, 10000)) = 0.0 //147

		_StencilComp ("Stencil Comparison", Float) = 8 //148
		_Stencil ("Stencil ID", Float) = 0
		_StencilOp ("Stencil Operation", Float) = 0
		_StencilWriteMask ("Stencil Write Mask", Float) = 255
		_StencilReadMask ("Stencil Read Mask", Float) = 255 //152
